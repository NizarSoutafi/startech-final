        ...
        <Card className="w-full max-w-md border-slate-200 bg-white shadow-2xl relative z-10">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="p-6 pt-0">
              <Button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white h-12 text-lg font-bold">INITIALISER SESSION</Button>
            </div>
          </form>
        </Card>
        <div className="absolute bottom-6 right-6 z-20">
          <Link href="/admin">
            <Button variant="ghost" className="text-slate-500 text-xs gap-2"><Shield className="w-3 h-3" /> Accès Admin</Button>
          </Link>
        </div>
      </div>
    )
